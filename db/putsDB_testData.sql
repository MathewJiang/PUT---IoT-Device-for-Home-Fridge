...
INSERT INTO `vendors` VALUES ('Metro'), ('Loblaws'), ('Sobbeys'), ('Veda'), ('McDonalds'), ('Lucky Moose'), ('default');
...
INSERT INTO `std_names` VALUES
                ...
                ('egg', 'egg'),
                ('oyster meat', 'seafood'),
                ('default item', 'uncategorized');

INSERT INTO `barcodes` VALUES
                ('064420000224', 'Sealtest', '3.25% milk', 1000, 'ml', 'T', 'box'),
...
INSERT INTO `purchase_history`
                (std_name, vendor, brand, content_quantity, content_unit, is_packaged, package_unit, purchase_date, expiry_date) VALUES 
...
INSERT INTO `consumption_history`
                (uid, std_name, consumed_quantity, remaining_quantity, action, time_stamp) VALUES
